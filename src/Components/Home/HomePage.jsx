      ...
      <section className="relative min-h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto max-w-4xl px-4">
          <div className="bg-pink-100/90 p-8 md:p-12 rounded-lg backdrop-blur-sm">
            <h1 className="mb-6 text-4xl md:text-5xl font-serif text-center" style={{ fontFamily: 'Old English Text MT, serif' }}>
              Revolutionizing Gift Giving
            </h1>
            <p className="mb-8 text-gray-700 text-center max-w-2xl mx-auto">
              Penatibus sem vitae mollis luctus mi tellus. Maximus eu eleifend aptent dapibus metus maecenas consequat. Elementum interdum a semper! Netus nullam eros nisi volutpat nibh ex ultricies. Pharetra sagittis sit aliquet at. Magna nam prates justo.
            </p>
  ...
  <div className="container mx-auto max-w-6xl">
    ...
    <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="overflow-hidden rounded-lg shadow-md group">
        ...
        <div className="p-6 bg-pink-50">
          <h3 className="text-xl font-semibold mb-2">Couple Gift Items</h3>
          <p className="text-gray-600 text-sm">
            Ante mus blandit sapien sociosqu per consequat ad.
          </p>
        </div>
